    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ps', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Search Project Symbols')
      ...
      vim.lsp.handlers['textDocument/hover'] = vim.lsp.with(vim.lsp.handlers.hover, {
        border = 'rounded',
        -- Debug: Print when hover is called
        on_open = function(win, buf)
          print('Hover window opened with border:', vim.api.nvim_win_get_config(win).border)
        end,
      })
